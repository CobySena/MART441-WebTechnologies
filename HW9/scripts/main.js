...
function showPokemonInfo()
{
    ...
    for(i = 0; i < 151; i++)
    {
      full_list = full_list + "Number: " + list.pokemon[i].num
      + "<br>Name: " + list.pokemon[i].name + "<br>Type: " + list.pokemon[i].type[0] + " " + list.pokemon[i].type[1] + "<br>Height: "
      + list.pokemon[i].height + "<br>Weight: " + list.pokemon[i].weight + "<br><br><br><br>";
    }

    $("#pokemonInformation").html(full_list);
}
